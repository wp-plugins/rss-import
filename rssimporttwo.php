...
function RSSImportTwo($display=0, $feedurl, $displaydescriptions=false, $truncatetitle=true, $truncatedescription=true, $word=100) {
	...
	if ($rss && !$rss->ERROR) {
		...
		foreach ($rss->items as $item) {
			...
			$display--;
			echo wptexturize('<p class="more-link"><a href="' . $href . '" title="' . $item['title'] . '"><strong>Weiterlesen &raquo;</strong></a></p>');
		}
